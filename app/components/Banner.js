            ...
            <div className="relative h-[400px] w-11/12 mt-20">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between md:flex-row">
                    <div className="w-full lg:-mt-16 md:-mt-20 md:w-1/2 flex flex-col justify-center p-5">
                        <div className="text-2xl md:text-4xl xl:text-4xl text-white font-bold text-shadow-lg md:pb-6">
                    ...
                    <div
                        className="w-full md:w-3/4 h-1/2 md:h-full lg:h-full bg-cover bg-no-repeat rounded-2xl"
                        style={{ 
